<div class="container-fluid py-4">
      <div class="row">
                    <div class="col-md-6">
                        <h1 class="h3 mb-2 text-white">Booking Table</h1>
                    </div>
                    <!-- <div class="col-md-6">
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0" >
                  <thead>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Room Category</th>
                      <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Customer Name</th>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <!-- <div class="modal-body">
        <form action="<?= site_url('Admin/room_booking')?>" method="post" enctype= "multipart/form-data">
