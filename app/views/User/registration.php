...
<head>
	...
	<!-- Font-->
    <link rel="stylesheet" href="<?php echo BASE_URL. PUBLIC_DIR?>/regform/css/nunito-font.css">
	<!-- <link rel="stylesheet" type="text/css" href="css/nunito-font.css"> -->
	<!-- Main Style Css -->
    <link rel="stylesheet" href="<?php echo BASE_URL. PUBLIC_DIR?>/regform/css/style.css">
    <!-- <link rel="stylesheet" href="css/style.css"/> -->
</head>
<body class="form-v9">
	<div class="page-content">
		<div class="form-v9-content" style="background-image: url('<?php echo BASE_URL. PUBLIC_DIR?>/regform/images/form-v9.jpg')">
